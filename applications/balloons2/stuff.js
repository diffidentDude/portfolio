...
export function vectorFn(fn, v1, v2) {
...
export const ceil = new Vector(x => Math.ceil(x * 100) / 100);
export const abs = new Vector(x => Math.abs(x));
export const sign = new Vector(x => Math.sign(x));
export const minus = new Vector(minusS);
export const add = new Vector(addS);
export const multiply = new Vector(multiplyS);
export const divide = new Vector(divideS);
export const lessThan = new Vector(lessThanS);
export const greaterThan = new Vector(greaterThanS);
export const direction = new Vector(addS, minusS);
 ...
 */
export function hypotenuse(v) {
    return Math.sqrt(Math.pow(v.x, 2) + Math.pow(v.y, 2));
}

export function theta({x:o, y:a}) {
    if (a == 0) {
        return 0;
    } else {
...
export function cirleOverlaps(c1, c2) {
...
export function objectCollisions(balls) {
...
export function collisionLoop(tester, worker, updatedBalls) {
    let iterations = 0;
...
export function collisionLoop2(tester, worker, updatedBalls) {
    let iterations = 0;
...
export function collisionLoop3(tester, worker, balls, ballPairs) {
    let iterations = 0;
...
export function collisionLoop4(tester, worker, balls, ballPairs) {
    let iterations = 0;
